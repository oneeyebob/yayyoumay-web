...
const SVGLogo = ({ height = 28, color = 'currentColor' }: { height?: number; color?: string }) => (
...
export default function BlogHeader() {
  return (
    <header style={{ borderBottom: '1px solid rgba(43,43,43,0.1)', background: '#F5F1E8', position: 'sticky', top: 0, zIndex: 50 }}>
      <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 1.25rem', height: 56, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <Link href="/" style={{ display: 'flex', color: '#2B2B2B' }}>
          <SVGLogo height={28} color="#2B2B2B" />
        </Link>
        <nav style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          <Link href="/blog" style={{ fontSize: '0.75rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(43,43,43,0.5)', textDecoration: 'none' }}>
            Alle indlæg
          </Link>
