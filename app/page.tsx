            ...
            {c.how.steps.map((step, i) => {
              ...
              return (
                <div key={i} style={{ textAlign: 'center', padding: '0 8px' }}>
                  {i === 0 || i === 2 ? (
                    <a href={i === 0 ? 'https://play.yayyoumay.dk/register' : 'https://play.yayyoumay.dk/demo'} className="step-link" style={{ width: 68, height: 68, background: YELLOW, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 24px', textDecoration: 'none' }}>
